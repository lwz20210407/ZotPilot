...
def test_pdf_records_for_assignment_keeps_cjk_repeated_number_formula_blocks():
    formula_record = _PdfEquationNumberRecord(
        number="(6)",
        y_center=566.2,
        x_right=471.0,
        standalone=False,
        bbox=(150.0, 540.0, 471.0, 590.0),
        text=(
            "方程（2）中的τ采用Bai-Johnson热塑性本构关系 "
            "τ＝τM γ γi n exp 1＋n 1－γ γi n＋1 （6） n＋1 （6）"
        ),
    ...
    reference_record = _PdfEquationNumberRecord(
        ...
        x_right=471.0,
        standalone=False,
        bbox=(150.0, 600.0, 471.0, 624.0),
        text="由方程（6）可以看出材料参数对剪切强度有影响。",
        page_width=595.0,
        page_height=842.0,
    )
...
def test_append_missing_pdf_numbered_candidates_skips_table_caption_noise(tmp_path):
    pdf_path = tmp_path / "paper.pdf"
    pdf_path.write_bytes(b"%PDF-1.4")
    scan = _PdfEquationNumberScanResult(
        records_by_page={
            12: [
                _PdfEquationNumberRecord(
                    ...
                    x_right=520.0,
                    standalone=False,
                    bbox=(36.0, 165.0, 520.0, 198.0),
                    text=(
                        "Table 2 Summary of feature extraction parameters used in the descriptor bank. "
                        "Feature type Description Parameters Intensity Raw grayscale intensity"
                    ),
                    page_width=595.0,
                    page_height=842.0,
                ),
                _PdfEquationNumberRecord(
                    ...
                    x_right=420.0,
                    standalone=False,
                    bbox=(110.0, 215.0, 420.0, 245.0),
                    text=r"D = \sum_i \Delta \epsilon_i / \epsilon_f (2-5)",
                    page_width=595.0,
                    page_height=842.0,
                ),
            ]
