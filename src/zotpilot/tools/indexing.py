...
def index_library(
    ...
    try:
        ...
        response = {
            ...
            "rate_limited_abort": result.get("rate_limited_abort", False),
            "systemic_abort": result.get("systemic_abort", False),
            "not_indexed_due_to_abort": result.get("not_indexed_due_to_abort", 0),
